...
const students = [
    { ID: 1, name: 'Kuldeep', age: 22, grade: 'B', degree: 'B.tech EL', email: 'kuldeep@example.com' },
    { ID: 2, name: 'Arpit', age: 25, grade: 'C', degree: 'B.tech EL', email: 'arpit@example.com' },
    { ID: 3, name: 'Preetam', age: 23, grade: 'A', degree: 'B.tech CSE', email: 'preetam@example.com' }
  ];
